...
let testCases = [
  {
    ...
    returnPartitions: [
      {
        type: 'bold', 
        value: 'This is a test for bold partitions'
      }
    ]
  },
  {
    ...
    returnPartitions: [
      {
        type: 'italics', 
        value: 'This is a test for italics partitions'
      }
    ]
  },
  {
    ...
    returnPartitions: [
      {
        type: 'link', 
        value: 'This is a test for links', 
        link: 'www.link.com'
      }
    ]
  },
  {
    ...
    returnPartitions: [
      {
        type: 'relation', 
        value: 'This is a test for relations', 
  ...
  },
  {
    ...
    returnPartitions: [
      {
        type: 'color', 
        value: 'This is a test for colors', 
        color: '#FF2200'
      }
    ]
  },
